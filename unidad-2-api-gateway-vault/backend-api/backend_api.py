"""
Paso 6 de la guía: proteger la API remota.

A partir de aquí, el backend YA NO acepta llamadas anónimas a /products ni
/orders: exige el header X-Gateway-Secret con el valor exacto configurado
en la variable de entorno INTERNAL_GATEWAY_SECRET. Esta es la credencial
"Gateway -> Backend" (Service Identity), distinta del Bearer Token que el
cliente usa contra el Gateway (Client Identity).
"""
